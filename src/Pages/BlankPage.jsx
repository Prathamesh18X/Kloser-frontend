  ...
  const deliveryDetails2 = [
    {
      type: "Home",
      name: "Ali Bin Ahmad",
      address: "123 Jalan Ampang, Apartment A-2-3, Ampang Point, 50450 Kuala Lumpur, Wilayah Persekutuan, Malaysia",
    ...
    },
    {
      type: "Work",
      name: "Ali Bin Ahmad",
      address: "Tech Solutions Sdn. Bhd., Level 15, Menara KL Eco City, 3 Jalan Bangsar, 59200 Kuala Lumpur, Wilayah Persekutuan, Malaysia",
      phone: "+60 1X-XXX XXXX",
      email: "zango@basicshapes.co",
    },
  ];
