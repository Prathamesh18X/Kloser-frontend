...
const Homepage = () => {
  return (
    <>
      ...
      <div className="max-w-[100%] gap-10 grid grid-cols-12 grid-rows-2 px-8">
        ...
        <Card className="w-full h-[300px] col-span-12 sm:col-span-7">
          ...
          />
          <CardFooter className="absolute bottom-0 z-10 flex justify-between items-center p-4">
            <Button
              className="bg-black/70 text-white hover:bg-black/90"
              radius="sm"
              size="sm"
            >
              <p className="text-white font-bold">RM80.20</p>
              <p className="text-white text-sm">store name: Kloser In-house</p>
            </Button>
          </CardFooter>
        </Card>
        <Card
