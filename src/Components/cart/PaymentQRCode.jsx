...
const PaymentQRCode = ({ qrCodeUrl, onCancelTransaction }) => {
  ...
  return (
    <div className='w-[480px] h-[calc(100vh-78.5px)] bg-default fixed top-[78.5px] right-0 z-50 overflow-y-auto flex flex-col items-center justify-between scrollbar-none custom-scrollbar'>
